<script>
  ...
  var tw_real_data={
    //Taiwan day_84           1    2   3
    Infectious  : [[0],[1],	[3],	[4],	[5],	[8],	[9],	[10],	[11],	[16],	[17],	[18],	[20],	[22],	[24],	[26],	[28],	[30],	[31],	[32],	[34],	[39],	[40],	[41],	[42],	[44],	[45],	[47],	[48],	[49],	[50],	[53],	[59],	[67],	[77],	[100],	[108],	[135],	[153],	[169],	[195],	[216],	[235],	[252],	[267],	[283],	[298],	[306],	[322],	[329],	[339],	[348],	[355],	[363],	[373],	[376],	[379],	[380],	[382],	[385],	[388],	[393]],
    Recovered   : [[0],[0],[1]],
    Fatalities  : [[2]]
  }
// end of tw data
...
//分類法
  ...
  window.addEventListener('mouseup', unlock_yaxis);
                                                //TW
  $: checked = [false, false, false, false, false,true, false,false,false,false,false,false] 
  $: active  = 0
...
<div class="chart" style="display: flex; max-width: 1120px">
    ...
    <div style="position:relative; top:48px; right:-115px">
      ...
      <div style="position:absolute; left:0px; top:0px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          ...
          <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 4px; position:relative;">對於疾病沒有免疫力之人口數</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*1}px; width: 180px; height: 100px">
        ...
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 4px; position:relative;">潛在感染人口數</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*2}px; width: 180px; height: 100px">
        ...
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 4px; position:relative;">感染活耀數量</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*3}px; width: 180px; height: 100px">
        ...
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 4x; position:relative;">因隔離或具免疫而不具感染力的人口數</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*4+14-3}px; width: 180px; height: 100px">
        ...
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 8px; position:relative;">完全康復者</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*4+57}px; width: 180px; height: 100px">
        ...
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 10px; position:relative;">住院人數</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*4 + 120+2}px; width: 180px; height: 100px">
        ...
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 10px; position:relative;">死亡人數</div>
      </div>
  ...
  <div style="flex: 0 0 890px; width:890px; height: {height+200}px; position:relative;">
...
<div style="height:150px;">
  <div class="minorTitle">
    <div style="margin: 0px 0px 5px 4px" class="minorTitleColumn">Country</div>
  </div>
...
<!-- country Taiwan-->
  <div class = "row">
    <div class="column">
    <div style="position:relative; left:0px; top:20px; width: 30px; height: 100px">
        <div class="legendtitle">Taiwan</div>
...
<!-- country Germany-->
    <div class="column">
    <div style="position:relative; left:0px; top:20px; width: 30px; height: 100px">
        <div class="legendtitle">Germany</div>
        <div class="legend" style="position:relative;">
...
<!-- country France-->
    <div class="column">
    <div style="position:relative; left:0px; top:20px; width: 30px; height: 100px">
        <div class="legendtitle">France</div>
        <div class="legend" style="position:relative;">
...
<!-- country Spain-->
    <div class="column">
    <div style="position:relative; left:0px; top:20px; width: 30px; height: 100px">
        <div class="legendtitle">Spain</div>
        <div class="legend" style="position:relative;">
        <Checkbox color="{colors[9]}" bind:checked={checked[9]}/>
        </div>
      </div>
    </div>
  ...
  <!-- country United States of America-->
    <div class="column">
    <div style="position:relative; left:-30px; top:20px; width: 200px; height: 100px">
        <div class="legendtitle">United States of America</div>
        <div class="legend" style="position:relative;">
        <Checkbox color="{colors[10]}" bind:checked={checked[10]}/>
        </div>
      </div>
    </div>
    ...
    <!--Country China-->
    <div class="column">
    <div style="position:relative; left:-30px; top:20px; width: 30px; height: 100px">
        <div class="legendtitle">China</div>
        <div class="legend" style="position:relative;">
        <Checkbox color="{colors[11]}" bind:checked={checked[11]}/>
        </div>
      </div>
    </div>
...
<div style="height:250px;">
  ...
  <div class = "row">
    <div class="column">
      ...
      <div class="paneldesc" style="height:30px">Size of population.<br>人口總數<br></div>
      ...
      <div class="paneldesc" style="height:29px; border-top: 1px solid #EEE; padding-top: 10px">Number of initial infections.初始感染人數<br></div>
    ...
    <div class="column">
      ...
      <div class="paneldesc" style="height:30px">Length of incubation period, {@html math_inline("T_{\\text{inc}}")}.潛伏期<br></div>
      ...
      <div class="paneldesc" style="height:29px; border-top: 1px solid #EEE; padding-top: 10px">Duration patient is infectious, {@html math_inline("T_{\\text{inf}}")}.可傳染期<br></div>
    ...
    <div class="column">
      ...
      <div class="paneldesc" style="height:30px">Case fatality rate.<br>死亡率<br></div>
    ...
    <div class="column">
      ...
      <div class="paneldesc" style="height:30px">Hospitalization rate.住院率<br></div>
